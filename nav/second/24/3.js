  ...
  <TouchableOpacity>
    <Text style={{fontSize:30,marginLeft:20}}>x</Text>
        ...
        <View style={{width:'97%',height:'94%',backgroundColor:'white',marginTop:7,alignSelf:'center'}}>
            <Text style={{fontSize:20,color:'black',textAlign:'center',marginTop:80}}>
...
بِسْمِ اللهِ الرَّحمَنِ الرّحِيم" قل أَعُوذُ بِرَبِّ الْفَلَقِ • مِن شَرِّ مَا خَلَقَ • وَمِن شَرِّ غَاسِقٍ إِذَا وَقَبَ • وَمِن شَرِّ النَّفَّاثَاتِ فِي الْعُقَدِ • وَمِن شَرِّ حَاسِدٍ إِذَا حَسَدَ"

بِسْمِ اللهِ الرَّحمَنِ الرّحِيم " قل أَعُوذُ بِرَبِّ النَّاسِ • مَلِكِ النَّاسِ • إِلَهِ النَّاسِ • مِن شَرِّ الْوَسْوَاسِ الْخَنَّاسِ • الَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاسِ • مِنَ الْجِنَّةِ وَ النَّاسِ"
            </Text>
            ...
            <View style={{borderBottomColor:'#c7c7c7',borderBottomWidth:1,marginTop:180}}></View> 
